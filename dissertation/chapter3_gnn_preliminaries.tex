...
culminating in the GATv2 correction that is used as the attention primitive in every experiment in this dissertation.
...
and every architecture evaluated in this dissertation uses GATv2 as its attention primitive.
