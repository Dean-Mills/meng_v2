...
\bottomrule
\end{tabular}
\caption[Baseline GAT architecture used as the comparison point for the evaluated methods.]{Baseline GAT architecture used as the comparison point for the
