...
\bottomrule
\end{tabular}
\caption[Baseline GAT architecture used as the comparison point for the methods evaluated in this chapter.]{Baseline GAT architecture used as the comparison point for the
