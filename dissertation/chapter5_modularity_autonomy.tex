...
\begin{figure}[H]
    ...
    \caption[Difference in PGA between predicted-$K$ and oracle-$K$ grouping as a function of keypoint recall for the three detector evaluations and the ground-truth-keypoint control.]{Difference in PGA between predicted-$K$ and oracle-$K$
