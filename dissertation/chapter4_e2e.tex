...
\begin{figure}[H]
    ...
    \caption[Four scored COCO scenes under the three end-to-end grouping configurations.]{Four scored COCO \texttt{val2017} scenes under the end-to-end evaluation protocol:
