...
\endfoot
\bottomrule
\caption[Concise mapping of each research question to its answer and the discussion section in which the supporting argument is developed.]{Concise mapping of each research question to its answer and the discussion section in which the supporting argument is developed.
