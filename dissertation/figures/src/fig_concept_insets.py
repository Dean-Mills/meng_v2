...
Run from code_v3/:
    python ../dissertation/figures/src/fig_concept_insets.py [--img_id 281759]
Writes dissertation/figures/concept_inset_ungrouped.pdf and concept_inset_grouped.pdf (+ .png).
"""
