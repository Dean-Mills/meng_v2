...
Vanilla SCOT remains the strongest formulation. The ablation shows that the core contribution is the type-constrained structured assignment via OT, not the specific parameterisation of temperature, cost, or marginal constraints. That said, K-free inference remains a valuable direction for future work --- the unbalanced formulation is the right idea but likely needs tighter $\rho$ values, better initialisation of the prototype pool, or a curriculum that starts with known $K$ and gradually relaxes to unbalanced.
